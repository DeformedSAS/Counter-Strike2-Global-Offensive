            ...
            if (claimedItemId) {
                aSelectedItems.forEach(selectedIndex => {
                    if (idx === selectedIndex) {
                        ...
                        $.DispatchEvent('PlaySoundEffect', 'UIPanorama.gift_claim', '');
                    }
                });
            }
        });
    ...
    function _OnItemSelected(elPanel) {
        ...
        if ((_CalcPendingBalance() + elPanel.Data().cost) <= m_redeemableBalance) {
            ...
            if (!elPanel.BHasClass('selected')) {
                $.DispatchEvent('PlaySoundEffect', 'UIPanorama.gift_select', 'MOUSE');
            }
            else {
                $.DispatchEvent('PlaySoundEffect', 'UIPanorama.gift_deselect', 'MOUSE');
            }
        }
        else {
